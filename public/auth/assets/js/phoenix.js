(function (global, factory) {
    ...
    const getStoreSpace = (e = localStorage) =>
        parseFloat(
            (
                escape(encodeURIComponent(JSON.stringify(e))).length / 1048576
            ).toFixed(2)
        );
            ...
            return function (t) {
                ...
                void 0 !== a &&
                    (n["min" === e ? "minDateHasTime" : "maxDateHasTime"] =
                        ...
                        a.getSeconds() > 0),
                    n.selectedDates &&
                        ((n.selectedDates = n.selectedDates.filter(function (
                            e
                        ) {
                            return S(e);
                        })),
                ...
                e.length &&
                    e.forEach((e) => {
                        ...
                        const i = e.querySelector(
                            ...
                            s = e.querySelector('[data-list-view="*"]'),
                            l = e.querySelector('[data-list-view="less"]'),
                            o = e.querySelector("[data-list-info]"),
                            c = new List(e, n);
                        c.on("updated", function (t) {
                            const i =
                                e.querySelector(".fallback") ||
                        ...
                        const g = c.items.length,
                            r = c.page,
                            d = c.listContainer.querySelector(".btn-close");
                        let u = Math.ceil(g / r),
                            p = c.visibleItems.length,
                            b = 1;
                        d &&
                            d.addEventListener("search.close", () => {
                                c.fuzzySearch("");
                            });
                        const h = () => {
                            o &&
                                (o.innerHTML = `${c.i} to ${p} <span class='text-600'> Items of </span>${g}`),
                                a && togglePaginationButtonDisable(a, 1 === b),
                                i && togglePaginationButtonDisable(i, b === u),
                                b > 1 &&
                                    b < u &&
    ...
    const phoenixOffcanvasInit = () => {
        const { getData: e } = window.phoenix.utils,
            o = document.querySelector("[data-phoenix-toggle='offcanvas']"),
            t = document.querySelector("[data-phoenix-backdrop]");
        if (o) {
            const n = e(o, "phoenix-target"),
                a = document.querySelector(n),
                c = a.querySelector("[data-phoenix-dismiss='offcanvas']"),
                d = () => {
            ...
            initialDomSetup(o.node),
                o.on("click", (c) => {
                    ...
                    if (n.data("theme-control")) {
                        ...
                        let i =
                            c.target[
                                "radio" === c.target.type ? "value" : "checked"
                            ];
                        switch (
                            ("phoenixTheme" === l &&
                                "boolean" == typeof i &&
    ...
    const { merge: merge } = window._,
        tinymceInit = () => {
            const { getColor: e, getData: t } = window.phoenix.utils,
                n = document.querySelectorAll("[data-tinymce]");
            if (window.tinymce) {
                n.forEach((n) => {
                    const i = t(n, "tinymce"),
                        o = merge(
