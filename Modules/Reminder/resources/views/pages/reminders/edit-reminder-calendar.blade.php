...
@section('content')
    ...
    <x-reminder::breadcrumb>
        <x-reminder::breadcrumb-item>
            <a href="{{ route('reminders.index') }}">{{ __('Home') }}</a>
        </x-reminder::breadcrumb-item>
    ...
    <div class="container">
        ...
        <div class="card my-3">
            ...
            <form action="{{ route('reminders.updateRemindersOnCalendar', ['reminder' => $reminder]) }}" method="POST"
                ...
                <div class="card-body">
                    ...
                    <div class="col-6">
                        ...
                        value="{{ isset($reminder) ? $reminder->reminder_start_date : old('reminder_start_date') }}"  id="reminder_start_date" required/>
                    </div>

                    <div class="col-6">
                        <x-reminder::dateTime-input label="{{ __('End date') }}" name="reminder_end_date"
                        value="{{ isset($reminder) ? $reminder->reminder_end_date : old('reminder_end_date') }}"  id="reminder_end_date" required/>
                    </div>
